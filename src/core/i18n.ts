...
const en = {
  ...
  'menu.startMatchMap': 'START MATCH — {name}',
  ...
  'inventory.dropHint': 'Drag an item here to drop it',
  'inventory.hint': 'Drag to reorder · Click to equip · Drag below to drop',
...
const ja: Dict = {
  ...
  'menu.startMatchMap': '{name}でマッチ開始',
  ...
  'inventory.dropHint': 'ここへドラッグして捨てる',
  'inventory.hint': 'ドラッグで並べ替え · クリックで装備 · 下へドラッグして捨てる',
