...
const en = {
  ...
  'lobby.startPhase3': 'START UNAVAILABLE — PHASE 4',
  'lobby.startExperimental': 'VERIFY START REQUEST',
  'lobby.phase3Gate': 'Phase 3 verifies the lobby and direct channels only. A live online match is not launched.',
  'lobby.startVerified': 'Start eligibility verified. Online match launch remains disabled until Phase 4.',
  'lobby.modeFfa': 'FFA',
...
const ja: Dict = {
  ...
  'lobby.failed': '失敗',
  'lobby.relay': 'ルーム探索',
  'lobby.startPhase3': '開始不可 — Phase 4で対応',
  'lobby.startExperimental': '開始条件を検証',
  'lobby.phase3Gate': 'Phase 3ではロビーと直接チャンネルのみ検証します。オンラインマッチは開始しません。',
  'lobby.startVerified': '開始条件を確認しました。オンラインマッチ開始はPhase 4完了まで無効です。',
  'lobby.modeFfa': 'FFA',
